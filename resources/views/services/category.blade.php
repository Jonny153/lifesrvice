    ...
    <section id="advantages" class="mt-5">
        <div class="container">
                    ...
                    <div class="adv-icon-container" data-tilt>
                        ...
                        <div class="adv-icon-bg">
                            ...
                            <div class="adv-icon d-flex flex-column justify-content-center">
                                @svg($current->slug, 'svg-medium text-white')
                            </div>
                        </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-9">
                    <div class="list-group text-center my-3 my-lg-5">
                        @foreach($current->services as $currentService)
                            <a href="/services/{{$current->slug}}/{{$currentService->slug}}" class="list-group-item list-group-item-action">
                                {{$currentService->name}}
                            </a>
                        @endforeach
                    </div>
